                ...
                <div class='card'>
                    <div class='card-header'>
                        ...
                        <form method='post' action='/pengguna'>
                            ...
                            <?php endif; ?>
                            <div>
                                <label for='txtNama' class="form-table">Nama</label>
                            ...
                            <div>
                                <label for='txtPassword' class="form-table">KataSandi</label>
                            ...
                            <div>
                                <label for='txtPassword2' class="form-table">Ulangi Kata Sandi</label>
